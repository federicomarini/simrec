...
author: "Katharina Ingel - Institute of Medical Biostatistics, Epidemiology and Informatics ([IMBEI](http://www.unimedizin-mainz.de/imbei), Mainz) - ingel@uni-mainz.de</br>
...
You can read more on this in our work (Jahn-Eimermacher et al. [3]).
...
3. Jahn-Eimermacher A, Ingel K, Ozga AK, Preussler S, Binder H (2015): Simulating recurrent event data with hazard functions defined on a total time scale. BMC Medical Research Methodology, 15:16  % doi:10.1186/s12874-015-0005-2
